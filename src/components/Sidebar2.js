...
const handleCollapsePages =()=>{
  ...
  return (
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" >
        ...
        {/* <!-- Sidebar - Brand --> */}
        <Link class="sidebar-brand d-flex align-items-center justify-content-center" to='/teachers'>
            <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas fa-laugh-wink"></i>
            </div>
            <div class="sidebar-brand-text mx-3">Teachers Dashboard<sup></sup></div>
        </Link>
        ...
        <li class="nav-item">
            ...
            <div id="collapseComponents" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <Link class="collapse-item" to="/createteachers">Create teachers</Link>
                    <Link class="collapse-item" to="/edit-teacher">Edit teachers</Link>
                    <Link class="collapse-item" to="/delete-teacher/:id">Delete teachers</Link>
                </div>
            </div>
        </li>
